...
.bubble { max-width:65%; padding:10px 14px; border-radius:16px; font-size:14px; line-height:1.5; position:relative; word-wrap:break-word; }
.bubble-mine { background:linear-gradient(135deg,rgba(0,217,156,.25),rgba(0,185,130,.15)); color:var(--text); border:1px solid rgba(0,217,156,.2); border-bottom-right-radius:4px; }
.bubble-theirs { background:var(--bg-soft); color:var(--text); border:1px solid var(--border); border-bottom-left-radius:4px; }
